    ...
    public drawZoneIndicator() {
        ...
        for (let p = 0; p < pageList.length; p++) {
            ...
            const indicatorRightX =
                margins[3] + innerWidth + this.INDICATOR_PADDING;
            ...
            lineTop.classList.add(
                `${EDITOR_PREFIX}-zone-indicator-border__top`,
            );
            ...
            lineLeft.classList.add(
                `${EDITOR_PREFIX}-zone-indicator-border__left`,
            );
