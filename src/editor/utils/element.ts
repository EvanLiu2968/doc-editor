...
export function formatElementList(
    ...
    while (i < elementList.length) {
        ...
        if (el.type === ElementType.TITLE) {
            ...
            // 前缀
            const prefixStrList = splitText(
                prefix || defaultControlOption.prefix,
            );
            ...
            if (
                        ...
                        for (let v = 0; v < valueSets.length; v++) {
                            ...
                            for (let e = 0; e < valueStrList.length; e++) {
                                ...
                                elementList.splice(i, 0, {
                                    ...
                                    value,
                                    type: el.type,
                                    letterSpacing: isLastLetter
                                        ? defaultCheckboxOption.gap
                                        : 0,
                                    control: el.control,
                ...
                if (editorOptions && editorOptions.control) {
                    thePlaceholderArgs.color =
                        editorOptions.control.placeholderColor;
                }
            ...
            // 后缀
            const postfixStrList = splitText(
                postfix || defaultControlOption.postfix,
            );
